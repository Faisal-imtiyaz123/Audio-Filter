...
\begin{lstlisting}
$https://github.com/Faisal-Imtiyaz123/Audio-Filter/codes/audio-filter-sound.wav
\end{lstlisting}
\item 
\label{Python code}
A Python Code is written to achieve Audio Filtering 
\lstinputlisting{./codes/filter.py}\label{prob:audio_filter_problem}
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/comparision.png}
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/Frequency_Response.png}
...
\end{align}
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
	https://github.com/Faisal-Imtiyaz123/Audio-Filtering/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
